		...
		for (let i = 0; i < menuItems.length; i++) {
			...
			if (mouseX >= menuX && mouseX <= menuX + menuWidth &&
				...
				switch(i) {
					case 0: // 第一單元作品
						if (!showIframe) {
							iframeElement.src = 'https://hanxiang0618-arch.github.io/20251024/';
					...
					case 1: // 第一單元講義
						if (!showIframe) {
							iframeElement.src = 'https://hackmd.io/@xiangli1234567899/SJMHuB0jex';
							iframeElement.style.display = 'block';
							showIframe = true;
						} else {
							iframeElement.style.display = 'none';
